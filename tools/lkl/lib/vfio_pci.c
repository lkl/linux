 ...
 * @ram_size - the size of kernel memory
 */
...
static void *vfio_alloc(unsigned long size)
{
	...
	/* To make it simple,
	 * the dma address is equal to the virtual address.
	 */
...
static void vfio_free(void *vaddr, unsigned long size)
{
